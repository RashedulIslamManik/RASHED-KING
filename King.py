...
"""%s
 ...
 • Info script :
 	 ...
 	 - author      : Rashedul Islam Manik

 - facebook    : facebook.com/Rashed.innocent.devil

 - Whatsapp     : +8801829772192

 - github      : github.com/RashedulislamManik.git
...
╚══════════════════════╝
 ...
 \033[1;90mAuthor \033[1;97m:  RASHED KING

 \033[1;90mFacebook \033[1;97m: Rashed.innocent.devil

\033[1;90m WatsApp \033[1;97m: +8801829772192
...
def hasill(c):
	...
	if c in[""]:
		...
		print "\n%s [01] Rashed crack akun %sOK "%(P,H)

        print "%s [02] Rashed crack akun %sCP "%(P,K)
